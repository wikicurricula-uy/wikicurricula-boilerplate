function toggleDarkMode() {
    const toTheTop = document.querySelector('.to-top');
    ...
    if (body.classList.contains('dark-mode')) {
        toTheTop.classList.add('to-top-dark');
        toTheTop.classList.remove('to-top-light');
        ...
        toTheTop.classList.add('to-top-light');
        toTheTop.classList.remove('to-top-dark');
        darkModeButton.innerHTML = `
