...
file_info = [
    ("117_en.txt", (os.path.abspath('../visualization/assets/data/ghana_voci_2023.tsv')), "ghana_en_subject_file.csv"),
    ("117_tw.txt", (os.path.abspath('../visualization/assets/data/ghana_voci_2023.tsv')), "ghana_tw_subject_file.csv"),
    ("uruguay_results.txt", (os.path.abspath('../visualization/assets/data/uruguay_voci_2023.tsv')), "uruguay_es_subject_file.csv")
]
